...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Event", b =>
                {
                    ...
                    b.HasIndex("SystemFrameRateId")
                        .HasDatabaseName("ix_events_system_frame_rate_id");

                    b.ToTable("events", (string)null);
                });

            modelBuilder.Entity("TASVideos.Data.Entity.EventAuthor", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");
                    ...
                    b.HasKey("UserId", "EventId")
                        .HasName("pk_event_authors");

                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_event_authors_event_id");

                    b.ToTable("event_authors", (string)null);
                });

            modelBuilder.Entity("TASVideos.Data.Entity.EventFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_event_files");

                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_event_files_event_id");

                    b.ToTable("event_files", (string)null);
                });

            modelBuilder.Entity("TASVideos.Data.Entity.EventFlag", b =>
                {
                    b.Property<int>("EventId")
                        .HasColumnType("integer")
                        .HasColumnName("event_id");
                    ...
                    b.HasKey("EventId", "FlagId")
                        .HasName("pk_event_flags");

                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_event_flags_event_id");

                    b.HasIndex("FlagId")
                        .HasDatabaseName("ix_event_flags_flag_id");

                    b.ToTable("event_flags", (string)null);
                });

            modelBuilder.Entity("TASVideos.Data.Entity.EventTag", b =>
                {
                    b.Property<int>("EventId")
                        .HasColumnType("integer")
                        .HasColumnName("event_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.EventUrl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_event_urls");

                    b.HasIndex("EventId")
                        .HasDatabaseName("ix_event_urls_event_id");

                    b.HasIndex("Type")
                        .HasDatabaseName("ix_event_urls_type");

                    b.ToTable("event_urls", (string)null);
                });
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.MovieFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("OriginalLength")
                        .HasColumnType("integer")
                        .HasColumnName("original_length");

                    b.HasKey("Id")
                        .HasName("pk_movie_files");

                    b.ToTable("movie_files", (string)null);
                });
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Publication", b =>
                {
                    ...
                    b.HasIndex("MovieFileId")
                        .HasDatabaseName("ix_publications_movie_file_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.PublicationFile", b =>
                {
                    ...
                    b.HasIndex("MovieFileId")
                        .HasDatabaseName("ix_publication_files_movie_file_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ForumPostId")
                        .HasDatabaseName("ix_reports_forum_post_id");

                    b.HasIndex("ReportedOn")
                        .HasDatabaseName("ix_reports_reported_on");

                    b.HasIndex("ReporterId")
                        .HasDatabaseName("ix_reports_reporter_id");

                    b.HasIndex("Resolved")
                        .HasDatabaseName("ix_reports_resolved");

                    b.HasIndex("ResolvedByUserId")
                        .HasDatabaseName("ix_reports_resolved_by_user_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Submission", b =>
                {
                    ...
                    b.HasIndex("MovieFileId")
                        .HasDatabaseName("ix_submissions_movie_file_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Event", b =>
                {
                    ...
                    b.HasOne("TASVideos.Data.Entity.Game.GameSystemFrameRate", "SystemFrameRate")
                        ...
                        .HasConstraintName("fk_events_game_system_frame_rates_system_frame_rate_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.EventAuthor", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.Event", "Event")
                        .WithMany("Authors")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_authors_events_event_id");
                    ...
                    b.HasOne("TASVideos.Data.Entity.User", "Author")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_authors_users_user_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.EventFile", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.Event", "Event")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_files_events_event_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.EventFlag", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.Event", "Event")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_flags_events_event_id");
                    ...
                    b.HasOne("TASVideos.Data.Entity.Flag", "Flag")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_flags_flags_flag_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.EventUrl", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.Event", "Event")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_event_urls_events_event_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Publication", b =>
                {
                    ...
                    b.HasOne("TASVideos.Data.Entity.MovieFile", "MovieFileData")
                        .WithMany()
                        .HasForeignKey("MovieFileId")
                        .HasConstraintName("fk_publications_movie_files_movie_file_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.PublicationFile", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.MovieFile", "MovieFileData")
                        .WithMany()
                        .HasForeignKey("MovieFileId")
                        .HasConstraintName("fk_publication_files_movie_files_movie_file_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Report", b =>
                {
                    b.HasOne("TASVideos.Data.Entity.Forum.ForumPost", "ForumPost")
                        .WithMany()
                        .HasForeignKey("ForumPostId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_reports_forum_posts_forum_post_id");

                    b.HasOne("TASVideos.Data.Entity.User", "Reporter")
                        .WithMany()
                    ...
                    b.HasOne("TASVideos.Data.Entity.User", "ResolvedByUser")
                        .WithMany()
                        .HasForeignKey("ResolvedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_reports_users_resolved_by_user_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Submission", b =>
                {
                    ...
                    b.HasOne("TASVideos.Data.Entity.MovieFile", "MovieFileData")
                        .WithMany()
                        .HasForeignKey("MovieFileId")
                        .HasConstraintName("fk_submissions_movie_files_movie_file_id");
            ...
            modelBuilder.Entity("TASVideos.Data.Entity.Event", b =>
                {
                    ...
                    b.Navigation("EventFlags");

                    b.Navigation("EventTags");

                    b.Navigation("EventUrls");
